...
${OBJECTDIR}/mrf_89xa_driver/test89xa.p1: mrf_89xa_driver/test89xa.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/mrf_89xa_driver" 
	@${RM} ${OBJECTDIR}/mrf_89xa_driver/test89xa.p1.d 
	@${RM} ${OBJECTDIR}/mrf_89xa_driver/test89xa.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1   -mdfp="${DFP_DIR}/xc8"  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -mwarn=-3 -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/mrf_89xa_driver/test89xa.p1 mrf_89xa_driver/test89xa.c 
	@-${MV} ${OBJECTDIR}/mrf_89xa_driver/test89xa.d ${OBJECTDIR}/mrf_89xa_driver/test89xa.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/mrf_89xa_driver/test89xa.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
	
${OBJECTDIR}/mrf_89xa_driver/drv_mrf_89xa.p1: mrf_89xa_driver/drv_mrf_89xa.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}/mrf_89xa_driver" 
	@${RM} ${OBJECTDIR}/mrf_89xa_driver/drv_mrf_89xa.p1.d 
	@${RM} ${OBJECTDIR}/mrf_89xa_driver/drv_mrf_89xa.p1 
